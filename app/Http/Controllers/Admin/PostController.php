...
class PostController extends Controller
{
    ...
    public function index()
    {
        ...
        // salvo in una variabile le categorie
        //$categories = Category::all();

        // tutto ciò che inserisco nel compact mi viene restituito e dunque posso andarlo a stamparlo nella view
    ...
    public function create()
    {
        ...
        // salvo in una variabile tutte le categorie, ottenendo cosi un array che restituisco alla view
        $categories = Category::all();
    ...
    public function update(PostRequest $request, Post $post)
    {
        ...
        if (array_key_exists('tags', $form_data)) {
            // sync sostituisce tutte le relazioni con quelle che vengono passate nell'array come parametro
